...
Sys.WebForms.Menu = function(options) {
    this.items = [];
    this.Departmenth = options.Departmenth || 1;
    ...
    if (this.parentMenuItem && this.parentMenuItem.parentMenu) {
        ...
        if (this.Departmenth > this.container.staticDisplayLevels) {
...
Sys.WebForms.MenuItem = function(parentMenu, listElement, topLevelMenuItem) {
    ...
    if (this._anchor) {
        ...
        if (subMenu) {
            this.childMenu = new Sys.WebForms.Menu({ element: subMenu, parentMenuItem: this, Departmenth: parentMenu.Departmenth + 1, container: this.container, keyMap: this.keyMap });
    ...
    if (this.parentMenu.Departmenth == 1 && this.container.orientation == 'horizontal') {
        Sys.WebForms.Menu._domHelper.setFloat(this.element, this.container.rightToLeft ? "right" : "left");
    }
...
Sys.WebForms.MenuItem.prototype = {
    ...
    navigateParent: function() {
        ...
        if (parentMenu.parentMenuItem && !parentMenu.isRoot()) {
            if (horizontal && this.parentMenu.Departmenth === 2) {
